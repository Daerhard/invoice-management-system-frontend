...
describe('useInvoiceFilters', () => {
    ...
    it('resetToDefault resets startDate and endDate to null', () => {
        const { result } = renderHook(() => useInvoiceFilters(), { wrapper: createWrapper() })
        act(() => {
            result.current.setYear('2022')
        })
